...
export const financeApi = {
  ...
  createFundAccount(payload: FundAccountWritePayload) {
    return apiClient.post<FundAccountDetail, FundAccountWritePayload>("/api/finance/fund-accounts/", payload);
  },
  ...
  async listTransactionsPage(
    ...
    const response = await apiClient.get<ListResponse<TransactionListItem>>("/api/finance/transactions/", {
      params: filters,
    });
